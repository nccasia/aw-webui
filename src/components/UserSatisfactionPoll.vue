<template lang="pug">
  div
    b-alert(v-if="isPollVisible", variant="info", show)
      ...
      form
        p
          | Hey there! You've been using KomuTracker for a while. How likely are you to recommend it to a friend/colleague on a scale 1-10? (with 10 being the most likely)
    ...
    b-alert(v-if="isPosFollowUpVisible", variant="info" show)
      ...
      p
        | We're happy to hear you enjoy using KomuTracker, but we can do better!
        br
        | To help us help you, here are a few things you can do:
      ul.small
        li
          | Support us on #[a(href="https://www.patreon.com/erikbjare") Patreon] or #[a(href="https://opencollective.com/komutracker") Open Collective] (or by #[a(href="https://komutracker.net/donate/") other donation methods]).
        li
          | Tell your friends and colleagues!
        li
          | Post about it on social media, we are on #[a(href="https://twitter.com/ActivityWatchIt") Twitter] and #[a(href="https://www.facebook.com/KomuTracker") Facebook].
        //li
          | Fill out the #[a(href="https://forms.gle/q2N9K5RoERBV8kqPA") feedback form].
        li
          | Rate us on #[a(href="https://alternativeto.net/software/komutracker/about/") AlternativeTo] and #[a(href="https://play.google.com/store/apps/details?id=net.komutracker.android") Google Play Store].
        li
    ...
    b-alert(v-if="isNegFollowUpVisible", variant="info" show)
      ...
      | We are sorry to hear that you did not like KomuTracker, but we want to improve! We would be very thankful if you helped us by:
      ul
        li
          | Fill out the #[a(href="https://forms.gle/q2N9K5RoERBV8kqPA") feedback form].
        li
          | Vote for new features on the #[a(href="https://forum.komutracker.net/c/features") forum].
</template>
